...
#Note that the following dict stores the actual detected categories, which need to be modified according to their actual data
#Here take the two categories of your own data set person and hat as an example, if it is a VOC data set, it is 20 categories
#Note that the category name is the same as the label name in the xml file

PRE_DEFINE_CATEGORIES = {"hand":0}
